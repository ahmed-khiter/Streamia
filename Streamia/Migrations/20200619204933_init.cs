    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UsersIptv", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BouquetSources", x => x.Id);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BouquetSources_Channels_ChannelId",
                        column: x => x.ChannelId,
                        principalTable: "Channels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BouquetSources_Movies_MovieId",
                        column: x => x.MovieId,
                        principalTable: "Movies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BouquetSources_Series_SeriesId",
                        column: x => x.SeriesId,
                        principalTable: "Series",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BouquetSources_Streams_StreamId",
                        column: x => x.StreamId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Servers_Channels_ChannelId",
                        column: x => x.ChannelId,
                        principalTable: "Channels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Servers_Series_SeriesId",
                        column: x => x.SeriesId,
                        principalTable: "Series",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BouquetSources_ChannelId",
                table: "BouquetSources",
                column: "ChannelId");

            migrationBuilder.CreateIndex(
                name: "IX_BouquetSources_MovieId",
                table: "BouquetSources",
                column: "MovieId");

            migrationBuilder.CreateIndex(
                name: "IX_BouquetSources_SeriesId",
                table: "BouquetSources",
                column: "SeriesId");

            migrationBuilder.CreateIndex(
                name: "IX_BouquetSources_StreamId",
                table: "BouquetSources",
                column: "StreamId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Servers_ChannelId",
                table: "Servers",
                column: "ChannelId");

            migrationBuilder.CreateIndex(
                name: "IX_Servers_MovieId",
                table: "Servers",
                column: "MovieId");

            migrationBuilder.CreateIndex(
                name: "IX_Servers_SeriesId",
                table: "Servers",
                column: "SeriesId");
